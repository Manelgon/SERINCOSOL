...
export default function DeleteConfirmationModal({
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-[200] flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200">
            <div
                className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 relative animate-in zoom-in-95 duration-200 border border-neutral-100"
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="block text-[10px] font-black text-neutral-400 uppercase tracking-widest mb-1.5 ml-1">Email Administrador</label>
                        <input
                            type="email"
                            required
                            disabled={isDeleting}
                    ...
                    <div>
                        <label className="block text-[10px] font-black text-neutral-400 uppercase tracking-widest mb-1.5 ml-1">Contraseña Administrador</label>
                        <input
                            type="password"
                            required
                            disabled={isDeleting}
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={isDeleting}
                            className="flex-1 h-12 px-6 bg-yellow-400 text-neutral-900 rounded-xl hover:bg-yellow-500 font-black text-xs uppercase tracking-[0.15em] transition-all shadow-lg shadow-yellow-100 disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                            {isDeleting ? (
                                <>
