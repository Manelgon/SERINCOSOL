...
const EMISOR = {
    nombre: process.env.EMISOR_NAME || "EMPRESA_NOMBRE",
    direccion: process.env.EMISOR_ADDRESS || "DIRECCION",
    ciudad: process.env.EMISOR_CITY || "CIUDAD",
    cif: process.env.EMISOR_CIF || "CIF",
};
...
export async function POST(req: Request) {
    ...
    try {
        // 0) Forzar precios desde servidor
