...
const EMISOR = {
    nombre: process.env.EMISOR_NAME || "SERINCOSOL",
    direccion: process.env.EMISOR_ADDRESS || "Gestión de Fincas",
};
...
export async function POST(req: Request) {
    ...
    const { stats, period, communityName, charts, userPerformance } = body;
