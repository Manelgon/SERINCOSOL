        ...
        try {
            ...
            if (session?.user) {
                ...
                if (data?.rol === 'admin') {
                    ...
                    console.log("User rol is:", data?.rol);
                }
            }
        } catch (e) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                {isAdmin && (
                    <a
                        href="/dashboard/fichaje/admin"
                        className="bg-neutral-900 text-white hover:bg-neutral-800 px-4 py-2 rounded-lg text-sm font-medium transition flex items-center gap-2"
                    >
